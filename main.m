...
% Quick Cfg update
% ila.cfg.days2run = datenum('30-Aug-2017'):datenum('22-Sept-2017'); % NAAMES 3
...
% Quick visualization to sync with TSG
% fig(30, 'sync TSG');
...
i=20; visSplit(ila.instrument.FTH.data,...
              ila.instrument.ACS298.raw.tsw.dt, ila.instrument.ACS298.raw.tsw.a(:,i),...
              ila.instrument.ACS298.raw.fsw.dt, ila.instrument.ACS298.raw.fsw.a(:,i),...
              ila.instrument.ACS298.raw.bad.dt, ila.instrument.ACS298.raw.bad.a(:,i),...
              'a (m^{-1})'); % ylim([-0.02 0.04]);
...
wl = ila.instrument.ACS301.lambda_ref; ACS = ila.instrument.ACS301.prod;
...
ila.instrument.ACS298.prod.p.chl_naames = 95 * line_height .^ 1.06;
ila.instrument.ACS298.prod.p.chl_naames(real(ila.instrument.ACS298.prod.p.chl_naames) ~= ila.instrument.ACS298.prod.p.chl_naames) = NaN;
...
fig(78); hold('on'); plot(wl, acs.ap(2000:2010, :), 'o-'); plot([676 676], ylim(), 'k');
...
visProd3D(ila.instrument.LISST.diameters(sel), ila.instrument.LISST.prod.p.dt, ila.instrument.LISST.prod.p.VSD(:,sel) * 10^-6, true, 'Log', false, 78);
