      ...
      switch obj.di_cfg.logger
        case 'InlininoACScsv'
          obj.raw.diw = iRead(@importInlininoACScsv, obj.path.di, obj.path.wk, obj.di_cfg.prefix,...
                         days2run, 'InlininoACScsv', force_import, ~write, ...
                         true, false, obj.di_cfg.postfix);
        case 'Compass_2.1rc_scheduled'
          obj.raw.diw = iRead(@importACS, obj.path.di, obj.path.wk, obj.di_cfg.prefix,...
                         days2run, 'Compass_2.1rc_scheduled', force_import, ~write, ...
                         true, false, obj.di_cfg.postfix);
        case 'Compass_2.1rc_scheduled_bin'
          obj.raw.diw = iRead(@importACSBin, obj.path.di, obj.path.wk, obj.di_cfg.prefix,...
                         days2run, 'Compass_2.1rc_scheduled_bin', force_import, ~write, ...
                         true, false, obj.di_cfg.postfix);
        case 'Compass_2.1rc'
          obj.raw.diw = iRead(@importACS, obj.path.di, obj.path.wk, obj.di_cfg.prefix,...
                         days2run, 'Compass_2.1rc', force_import, ~write, ...
                         true, false, obj.di_cfg.postfix);
        otherwise
          error('ACS: Unknown logger.');
      end
        ...
        case 'linear'
          if compute_dissolved
            [obj.prod.p, obj.prod.g, obj.prod.QCfailed] = processACS(lambda, ...
              ...
              [], SWT.qc.tsw, SWT_constants, interpolation_method, di_method);
          else
            [obj.prod.p, obj.prod.g, obj.prod.QCfailed] = processACS(lambda, ...
              obj.qc.tsw, obj.qc.fsw, obj.modelG50, obj.modelmphi, [], ...
              [], SWT.qc.tsw, SWT_constants, interpolation_method);
          end
        case 'CDOM'
          if compute_dissolved
            [obj.prod.p, obj.prod.g, obj.prod.QCfailed] = processACS(lambda, ...
              obj.qc.tsw, obj.qc.fsw, obj.modelG50, obj.modelmphi, obj.bin.diw, ...
              CDOM.qc.tsw, SWT.qc.tsw, SWT_constants, interpolation_method, di_method);
          else
            [obj.prod.p, obj.prod.g, obj.prod.QCfailed] = processACS(lambda, ...
              obj.qc.tsw, obj.qc.fsw, obj.modelG50, obj.modelmphi, [], ...
