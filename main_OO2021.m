...
%%
ila.cfg.instruments2run = {'FLOW','BB3'}; % 'FLOW', 'TSG', 'BB3', 'ACS94', 'AC9274'
...
ila.DiagnosticPlot('BB',{'raw'}); % AC or BB and level to plot
...
%% re-write final version of 'qc', 'bin', 'raw'
ila.Write('raw', 'part')
ila.Write('bin', 'part')
ila.Write('qc', 'part')
