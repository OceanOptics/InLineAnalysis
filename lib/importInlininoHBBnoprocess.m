function [ data, lambda ] = importInlininoHBBnoprocess( filename, calfile_plaque, calfile_temp, verbose )
...
% Build table
dat = table(datetime(t{1}), t{2}, t{3}, t{6}, t{7}, t{8}, t{9}, t{10}, ...
...
for ks = unique(dat.ScanIdx')
  ...
  if length(unique(dat.PmtGain(scanSel)))~=1
    if p.Results.RemoveMultiplePmtGains
      if verbose
...
function [data, lambda] = reformatHBB(dat)
...
data = table();
DataIdx = NaN(size(uscan, 1), 28);
StepPos = NaN(size(uscan, 1), 28);
NetRef = NaN(size(uscan, 1), 28);
Scat1 = NaN(size(uscan, 1), 28);
Scat2 = NaN(size(uscan, 1), 28);
Scat3 = NaN(size(uscan, 1), 28);
ScatCor1 = NaN(size(uscan, 1), 28);
ScatCor2 = NaN(size(uscan, 1), 28);
ScatCor3 = NaN(size(uscan, 1), 28);
ScatTempCor1 = NaN(size(uscan, 1), 28);
...
NetSig1 = NaN(size(uscan, 1), 28);
NetSig2 = NaN(size(uscan, 1), 28);
NetSig3 = NaN(size(uscan, 1), 28);
SigOn1 = NaN(size(uscan, 1), 28);
SigOn1Std = NaN(size(uscan, 1), 28);
RefOn = NaN(size(uscan, 1), 28);
RefOnStd = NaN(size(uscan, 1), 28);
SigOff1 = NaN(size(uscan, 1), 28);
SigOff1Std = NaN(size(uscan, 1), 28);
RefOff = NaN(size(uscan, 1), 28);
RefOffStd = NaN(size(uscan, 1), 28);
SigOn2 = NaN(size(uscan, 1), 28);
SigOn2Std = NaN(size(uscan, 1), 28);
SigOn3 = NaN(size(uscan, 1), 28);
SigOn3Std = NaN(size(uscan, 1), 28);
SigOff2 = NaN(size(uscan, 1), 28);
SigOff2Std = NaN(size(uscan, 1), 28);
SigOff3 = NaN(size(uscan, 1), 28);
SigOff3Std = NaN(size(uscan, 1), 28);
...
for i = 1:size(uscan, 1)
  DataIdx(i, foo(dat.ScanIdx == uscan(i))) = dat.DataIdx(dat.ScanIdx == uscan(i))';
  StepPos(i, foo(dat.ScanIdx == uscan(i))) = dat.StepPos(dat.ScanIdx == uscan(i))';
  NetRef(i, foo(dat.ScanIdx == uscan(i))) = dat.NetRef(dat.ScanIdx == uscan(i))';
  Scat1(i, foo(dat.ScanIdx == uscan(i))) = dat.Scat1(dat.ScanIdx == uscan(i))';
  Scat2(i, foo(dat.ScanIdx == uscan(i))) = dat.Scat2(dat.ScanIdx == uscan(i))';
  Scat3(i, foo(dat.ScanIdx == uscan(i))) = dat.Scat3(dat.ScanIdx == uscan(i))';
  ScatCor1(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatCor1(dat.ScanIdx == uscan(i))';
  ScatCor2(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatCor2(dat.ScanIdx == uscan(i))';
  ScatCor3(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatCor3(dat.ScanIdx == uscan(i))';
  ScatTempCor1(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatTempCor1(dat.ScanIdx == uscan(i))';
  ScatTempCor2(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatTempCor2(dat.ScanIdx == uscan(i))';
  ScatTempCor3(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatTempCor3(dat.ScanIdx == uscan(i))';
  ScatTempCorX(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatTempCorX(dat.ScanIdx == uscan(i))';
  beta(i, foo(dat.ScanIdx == uscan(i))) = dat.beta(dat.ScanIdx == uscan(i))';
  TempCorrCoeff(i, foo(dat.ScanIdx == uscan(i))) = dat.TempCorrCoeff(dat.ScanIdx == uscan(i))';
  ScatX(i, foo(dat.ScanIdx == uscan(i))) = dat.ScatX(dat.ScanIdx == uscan(i))';
  GainX(i, foo(dat.ScanIdx == uscan(i))) = dat.GainX(dat.ScanIdx == uscan(i))';
  NetSig1(i, foo(dat.ScanIdx == uscan(i))) = dat.NetSig1(dat.ScanIdx == uscan(i))';
  NetSig2(i, foo(dat.ScanIdx == uscan(i))) = dat.NetSig2(dat.ScanIdx == uscan(i))';
  NetSig3(i, foo(dat.ScanIdx == uscan(i))) = dat.NetSig3(dat.ScanIdx == uscan(i))';
  SigOn1(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn1(dat.ScanIdx == uscan(i))';
  SigOn1Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn1Std(dat.ScanIdx == uscan(i))';
  RefOn(i, foo(dat.ScanIdx == uscan(i))) = dat.RefOn(dat.ScanIdx == uscan(i))';
  RefOnStd(i, foo(dat.ScanIdx == uscan(i))) = dat.RefOnStd(dat.ScanIdx == uscan(i))';
  SigOff1(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff1(dat.ScanIdx == uscan(i))';
  SigOff1Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff1Std(dat.ScanIdx == uscan(i))';
  RefOff(i, foo(dat.ScanIdx == uscan(i))) = dat.RefOff(dat.ScanIdx == uscan(i))';
  RefOffStd(i, foo(dat.ScanIdx == uscan(i))) = dat.RefOffStd(dat.ScanIdx == uscan(i))';
  SigOn2(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn2(dat.ScanIdx == uscan(i))';
  SigOn2Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn2Std(dat.ScanIdx == uscan(i))';
  SigOn3(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn3(dat.ScanIdx == uscan(i))';
  SigOn3Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOn3Std(dat.ScanIdx == uscan(i))';
  SigOff2(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff2(dat.ScanIdx == uscan(i))';
  SigOff2Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff2Std(dat.ScanIdx == uscan(i))';
  SigOff3(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff3(dat.ScanIdx == uscan(i))';
  SigOff3Std(i, foo(dat.ScanIdx == uscan(i))) = dat.SigOff3Std(dat.ScanIdx == uscan(i))';
end

data.DataIdx = DataIdx;
data.StepPos = StepPos;
data.NetRef = NetRef;
data.Scat1 = Scat1;
data.Scat2 = Scat2;
data.Scat3 = Scat3;
data.ScatCor1 = ScatCor1;
data.ScatCor2 = ScatCor2;
data.ScatCor3 = ScatCor3;
data.ScatTempCor1 = ScatTempCor1;
data.ScatTempCor2 = ScatTempCor2;
data.ScatTempCor3 = ScatTempCor3;
data.ScatTempCorX = ScatTempCorX;
data.beta = beta;
data.TempCorrCoeff = TempCorrCoeff;
data.ScatX = ScatX;
data.GainX = GainX;
data.NetSig1 = NetSig1;
data.NetSig2 = NetSig2;
data.NetSig3 = NetSig3;
data.SigOn1 = SigOn1;
data.SigOn1Std = SigOn1Std;
data.RefOn = RefOn;
data.RefOnStd = RefOnStd;
data.SigOff1 = SigOff1;
data.SigOff1Std = SigOff1Std;
data.RefOff = RefOff;
data.RefOffStd = RefOffStd;
data.SigOn2 = SigOn2;
data.SigOn2Std = SigOn2Std;
data.SigOn3 = SigOn3;
data.SigOn3Std = SigOn3Std;
data.SigOff2 = SigOff2;
data.SigOff2Std = SigOff2Std;
data.SigOff3 = SigOff3;
data.SigOff3Std = SigOff3Std;
end
