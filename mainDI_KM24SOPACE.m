...
%% Quick cfg update
ila.cfg.days2run = datenum(2024,10,23):datenum(2024,11,7);
% ila.cfg.days2run = datetime(2024,11,8):datetime(2024,12,2);
% ila.cfg.days2run = datetime(2024,12,2):datetime(2024,12,16);

%% 'FLOW', 'SBE4536073', 'ACS91', 'ACS111', 'HyperBB8005', 'WS3S1081P','SUVF6244','LISST100X1183'
...
ila.SpectralQC('AC',{'qc'}, false, {'diw','a'});
...
%     - to QC 'beta' of 'fsw' table of 'bin' level of HBB, BB3, or LISST:  ila.SpectralQC('BB',{'bin'}, false, {'fsw','beta'})
%     - to QC 'ag' of 'g' table of prod level of ACs:  ila.SpectralQC('AC',{'prod'}, false, {'g','ag'})
ila.SpectralQC('AC',{'bin'}, false, {'diw','a'});
...
ila.cfg.calibrate.(ila.cfg.qcref.view).compute_dissolved = true;
ila.cfg.calibrate.(ila.cfg.qcref.view).di_method = 'best_di'; % best_di normal
ila.Calibrate()
ila.CheckDataStatus();
