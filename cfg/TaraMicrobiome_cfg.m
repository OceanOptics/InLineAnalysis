...
PATH_ROOT = '/Users/gui/Documents/MATLAB/InLineAnalysis/InLineAnalysis-master/';
PATH_DATA = '/Volumes/Samsung_T5/Data/TaraMicrobiome/';
...
cfg.instruments.(['ACS' SN]).device_file = [PATH_DATA filesep 'DeviceFiles' filesep 'acs057_20200129.dev'];
...
cfg.process.di.skip = {}; % 'FLOW', 'TSG', 'ACS57', 'BB31502', 'WSCD859'
...
cfg.process.flag.skip = {'FLOW', 'TSG', 'ACS57', 'BB31502', 'WSCD859', 'AC9', 'ACS007', 'ACS091', 'ACS111', 'ACS279', 'LISST', 'WSCD1082P', 'ALFA','PAR'};
