...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cfg.meta.investigators = 'Alison_Chase,Guillaume_Bourdin';
cfg.meta.affiliations = 'University_of_Washington';
cfg.meta.emails = 'alichase@uw.edu';
cfg.meta.experiment = 'KM24SOPACE';
cfg.meta.cruise = 'KM24SOPACE';
cfg.meta.station = 'NA';
...
PATH_ROOT = '/Volumes/Chase-SSD1/KM24-SOPACE';
...
cfg.instruments.(['ACS' SN]).device_file = fullfile(PATH_ROOT, 'DeviceFiles', 'ACS091_20240510.dev');
