...
PATH_ROOT = '/Volumes/Chase-SSD1/TaraEuropa';
...
cfg.instruments.([model SN]).device_file = fullfile(PATH_ROOT, 'DeviceFiles', 'acs003_20220602.dev');
cfg.instruments.([model SN]).path = struct('raw', fullfile(PATH_ROOT, 'raw', [model SN]),...
...
cfg.instruments.([model SN]).analog_channel = 'C2';
