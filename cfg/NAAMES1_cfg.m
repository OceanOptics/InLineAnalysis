...
cfg.instruments.TSG.path = struct('raw',  [PATH_ROOT '01_underway/raw/'],...
                                  'wk',   [PATH_ROOT '01_underway/mat/'],...
                                  'prod', [PATH_ROOT '01_underway/sb/'],...
                                  'ui', [PATH_ROOT '01_underway/ui/']);
...
cfg.instruments.FTH.path = struct('raw',  [PATH_ROOT '01_flow/raw/'],...
                                  'wk',   [PATH_ROOT '01_flow/mat/'],...
                                  'prod', [PATH_ROOT '01_flow/sb/'],...
                                  'ui', [PATH_ROOT '01_flow/ui/']);
...
cfg.instruments.ACS.device_file = [PATH_ROOT '01_acs/acs091.dev'];
...
cfg.instruments.ACS.path = struct('raw',  [PATH_ROOT '01_acs/raw/'],...
                                  'wk',   [PATH_ROOT '01_acs/wk/'],...
                                  'prod', [PATH_ROOT '01_acs/sb/'],...
                                  'ui', [PATH_ROOT '01_acs/ui/']);
...
cfg.instruments.BB3.path = struct('raw',  [PATH_ROOT '01_inline/raw/'],...
                                  'wk',   [PATH_ROOT '01_inline/mat/'],...
                                  'prod', [PATH_ROOT '01_inline/sb/'],...
                                  'ui', [PATH_ROOT '01_inline/ui/']);
...
cfg.instruments.WSCD.path = struct('raw',  [PATH_ROOT '01_inline/raw/'],...
                                  'wk',   [PATH_ROOT '01_inline/mat/'],...
                                  'prod', [PATH_ROOT '01_inline/sb/'],...
                                  'ui', [PATH_ROOT '01_inline/ui/']);
