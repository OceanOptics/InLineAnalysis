...
cfg.instruments.ACS301.device_file = [PATH_ROOT 'DeviceFiles/acs301_20180806.dev'];
cfg.instruments.ACS301.path = struct('raw',  [PATH_ROOT 'raw' filesep 'ACS301' filesep],...
                                    'di',  [PATH_ROOT 'raw' filesep 'ACS301' filesep 'DI' filesep],...
                                    'wk',   [PATH_ROOT 'wk' filesep 'ACS301' filesep],...
                                    'prod', [PATH_ROOT 'prod' filesep],...
                                    'ui', [PATH_ROOT 'ui' filesep 'ACS301' filesep]);
...
cfg.instruments.BB31502.path = struct('raw',  [PATH_ROOT 'raw' filesep 'BB31502' filesep],...
                                  'di',  [PATH_ROOT 'raw' filesep 'BB31502' filesep],...
                                  'wk',   [PATH_ROOT 'wk' filesep 'BB31502' filesep],...
                                  'prod', [PATH_ROOT 'prod' filesep],...
                                  'ui', [PATH_ROOT 'ui' filesep 'BB31502' filesep]);
...
cfg.instruments.WSCD1082.slope = 62;
cfg.instruments.WSCD1082.dark = 0.059;
cfg.instruments.WSCD1082.path = struct('raw',  [PATH_ROOT 'raw' filesep 'WSCD1082' filesep],...
                                  'wk',   [PATH_ROOT 'wk' filesep 'WSCD1082' filesep],...
                                  'prod', [PATH_ROOT 'prod' filesep],...
                                  'ui', [PATH_ROOT 'ui' filesep 'WSCD1082' filesep]);
...
%%% General parameters %%%
cfg.process.days2run = datenum(2019,05,27):datenum(2019,06,03);
...
cfg.process.split.skip = {'FTH','TSG','WSCD1082'};
